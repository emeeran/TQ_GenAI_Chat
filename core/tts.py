    ...
    def get_voices(self) -> list[TTSVoice]:
        ...
        if pyttsx3:
            try:
                ...
                current_app.logger.warning(f"Failed to get pyttsx3 voices: {e}")
    ...
    def synthesize(self, text: str, voice_id: str | None = None,
        ...
        if pyttsx3:
            try:
                ...
                current_app.logger.warning(f"pyttsx3 synthesis failed: {e}")
        ...
        if gTTS:
            try:
                ...
                current_app.logger.error(f"gTTS synthesis failed: {e}")
    ...
    def _synthesize_pyttsx3(self, text: str, voice_id: str | None) -> tuple[bytes, str]:
        ...
        if voice_id:
            try:
                ...
                current_app.logger.warning(f"Failed to set voice {voice_id}: {e}")
