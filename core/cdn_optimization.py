...
if __name__ == "__main__":
    ...
    async def main():
        ...
        results = await asset_manager.build_and_deploy()
        print(f"Build results: {json.dumps(results, indent=2)}")
        
        # Get optimized URLs
        css_url = asset_manager.get_asset_url('styles.css')
        js_url = asset_manager.get_asset_url('script.js')
