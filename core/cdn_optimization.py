...
class AssetOptimizer:
    ...
    async def optimize_all_assets(self) -> dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"Asset optimization completed: {results['compression_ratio']:.2%} reduction"
            )
        ...
        for image_file in image_files:
            try:
                ...
                with Image.open(image_file) as img:
                    ...
                    logger.info(
                        f"Optimized {image_file.name}: {original_size} → {optimized_size} bytes"
                    )
...
class CDNManager:
    ...
    async def upload_assets(self, source_dir: str) -> dict[str, Any]:
        ...
        results = {"uploaded_files": 0, "failed_uploads": 0, "total_size": 0, "errors": []}
    ...
    async def _cdn_upload_request(
        self, file_path: Path, content: bytes, content_type: str, cache_control: str
    ):
...
class AssetManager:
    ...
    async def build_and_deploy(self) -> dict[str, Any]:
        ...
        results = {"optimization": {}, "upload": {}, "total_time": 0, "success": False}
