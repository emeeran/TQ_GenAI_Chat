...
if __name__ == "__main__":
    ...
    async def main():
        ...
        # Get dashboard data
        system_dashboard = monitoring.dashboard.generate_system_dashboard()
        app_dashboard = monitoring.dashboard.generate_application_dashboard()
        health_status = monitoring.get_health_status()
        
        print("System Dashboard:", json.dumps(system_dashboard, indent=2, default=str))
        print("App Dashboard:", json.dumps(app_dashboard, indent=2, default=str))
